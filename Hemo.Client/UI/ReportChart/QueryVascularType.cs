...
{
    public partial class QueryVascularType : ViewBase
    {
        #region 类变量
        ...
        /// <param name="e"></param>
        private void QueryVascularType_Load(object sender, EventArgs e)
        {
            RunBackgroundWorker();
        }
        ...
        private void LoadChartData()
        {
            ...
            if (dtPatient != null && dtPatient.Rows.Count > 0)
            {
                ...
                {
                    DataTable dtSubCount = _hemodialysisService.GetVascularTypeCountByHemoIdAndDate(row["HEMODIALYSIS_ID"].ToString(), this.beginTime.DateTime, this.endTime.DateTime);
