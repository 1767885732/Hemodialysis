...
{
    public partial class WaterHemoEdit :HemoBaseFrm
    {
        #region 类变量
        ...
        private void WaterHemoMachineEdit_Load(object sender, EventArgs e)
        {
        ...
        private bool IsDataValidate()
        {
            ...
            if (string.IsNullOrEmpty(this.txt_spec.Text))
            {
                this.txt_spec.Focus();
                this.errorProvider.SetError(this.txt_spec, "请输入格规");
                return false;
            }
            return true;
        }

        public WaterHemoEdit()
        {
            InitializeComponent();
        }
