...
namespace Hemo.Client.UI.Config {
    public partial class CtlConfigListGroup : XtraUserControl {
        #region 变量
        ...
        public CtlConfigListGroup(string itemType)
        {
            InitializeComponent();
        ...
        /// <param name="e"></param>
        private void CtlConfigListGroup_Load(object sender, EventArgs e)
        {
            InitializeControls();
        }
        ...
        {
            var row = this.gvConfig.GetFocusedDataRow() as ConfigModel.MED_COMMON_ITEMLISTRow;
        }
