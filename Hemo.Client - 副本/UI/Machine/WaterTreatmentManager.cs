...
{
    public partial class WaterTreatmentManager : ViewBase
    {
        #region 类变量
        ...
        private void WaterTreatmentManager_Load(object sender, EventArgs e)
        {
        ...
        {
            WaterTreatemtReport frm = new WaterTreatemtReport(_data, GetJiDuStartMonth());
        ...
        {
            WaterTreatmentEdit frm = new WaterTreatmentEdit();
            frm.CurrentRow = null;
        ...
        private void InitalizeData()
        {
            ...
            using (BackgroundWorker worker = new BackgroundWorker())
            {
                worker.DoWork += delegate(object sender1, DoWorkEventArgs e1)
                {
                    ...
                    _data = _machineService.GetWaterTreatmentDataByParms(Utilities.Utility.CDate(this.beginTime.EditValue.ToString()), Utilities.Utility.CDate(this.endTime.EditValue.ToString()), machineID);
                };
