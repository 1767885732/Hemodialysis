...
namespace Hemo.Client.UI.Patient {
    public partial class PatientSufficiencyUI : ViewBase {
        #region 类变量
        ...
        private void dxSimpleButton1_Click(object sender, EventArgs e) {
            ...
            _patientDocRow = patientService.GetPatientListByParams(string.Empty, CurrentHemoId)[0];
