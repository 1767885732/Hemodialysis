...
{
    public partial class PatientKnowBooksUI : ViewBase
    {
        #region 类变量
        ...
        /// <param name="e"></param>
        private void PatientKnowBooksUI_Load(object sender, EventArgs e)
        {
            this.Text = "知情同意书";
