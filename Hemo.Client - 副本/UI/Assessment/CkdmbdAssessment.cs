...
{
    public partial class CkdmbdAssessment : DevExpress.XtraEditors.XtraUserControl
    {
        #region 类变量
        ...
        {
            using (EditCKDMBD frm = new EditCKDMBD(dt, null))
            {
        ...
        private void gridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                using (EditCKDMBD frm = new EditCKDMBD(dt, (HemodialysisModel.MED_ANEMIA_CKDMBD_ASSESSRow)this.gridView1.GetFocusedDataRow()))
                {
                    frm.HEMODIALYSIS_ID = HEMODIALYSIS_ID;
                    if (frm.ShowDialog() == DialogResult.OK)
                    {
        ...
        private void CkdmbdAssessment_Load(object sender, EventArgs e)
        {
        ...
        void Query()
        {
            ...
            if (this.txtFromDate.EditValue == null && this.txtToDate.EditValue == null)
            {
                dt = _hemoService.GetMED_ANEMIA_CKDMBD_ASSESS("CKDMBD", HEMODIALYSIS_ID);
            }
            else if (this.txtFromDate.EditValue != null && this.txtToDate.EditValue != null)
            {
                dt = _hemoService.GetMED_ANEMIA_CKDMBD_ASSESSbyDate(this.txtFromDate.DateTime, this.txtToDate.DateTime, "CKDMBD", HEMODIALYSIS_ID);
            }
