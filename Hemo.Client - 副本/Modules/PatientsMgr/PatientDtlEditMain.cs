        ...
        private void InzationPatientCurrentData()
        {
            ...
            using (BackgroundWorker worker = new BackgroundWorker())
            {
                ...
                worker.DoWork += delegate(object sender1, DoWorkEventArgs e1)
                {
                    ...
                    {
                        patientRow["BED_NUMBERNAME"] = this._bedDataTable.FindByITEM_ID(patientRow["BED_NUMBER"].ToString()).ITEM_VALUE;
                ...
                {
                    patientDataTable.DefaultView.Sort = "BED_NUMBERNAME ASC";
                    ...
                    if (patientDataTable != null && patientDataTable.Rows.Count > 0)
                    {
                        ...
                        CtlManagerPerson[] ctls = new CtlManagerPerson[dtSub.Rows.Count + 1];
                        int index = 0;
