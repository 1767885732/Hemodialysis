...
{
    public partial class QualityMonitorIndicatorReportNew : XtraReport
    {
        #region 构造函数

        public QualityMonitorIndicatorReportNew(DataTable dtResult, string title)
        {
            InitializeComponent();
            ...
            this.DetailReport3.DataMember = (dtResult != null) ? dtResult.TableName : string.Empty;
            this.DetailReport3.DataSource = dtResult;
            this.DetailReport4.DataMember = (dtResult != null) ? dtResult.TableName : string.Empty;
            this.DetailReport4.DataSource = dtResult;
        }
        ...
        private void CreateTable()
        {
            ...
            table1.SizeF = new SizeF(670F, 25F);
            ...
            cellSecondaryShpt.Name = "xrTableCell4";
            ...
            cellPressureControl.Name = "xrTableCell5";
            ...
            row1.Cells.AddRange(new XRTableCell[] { cellDate, cellUreaRemove, cellRenalAnemia, cellCa_P_Metabolism, cellSecondaryShpt, cellPressureControl });
            row1.Cells[0].WidthF = 101F;
            row1.Cells[1].WidthF = 95F;
            row1.Cells[2].WidthF = 125F;
            row1.Cells[3].WidthF = 95F;
            row1.Cells[4].WidthF = 155F;
            ...
            table2.SizeF = new SizeF(1155F, 25F);
            ...
            cellVenousCatheter.Name = "xrTableCell7";
            ...
            cellAutologousFistula.Name = "xrTableCell8";
            ...
            cellTempVenousCatheter.Name = "xrTableCell9";
            ...
            cellArtificialVessel.Name = "xrTableCell10";
            ...
            cellDoubleVein.Name = "xrTableCell11";
            ...
            cellHighAvf.Name = "xrTableCell12";
            ...
            cellJugularVenousCatheter.Name = "xrTableCell13";
            ...
            cellSubclavianVenousCatheter.Name = "xrTableCell14";
            ...
            cellFemoralVenousCatheter.Name = "xrTableCell15";
            ...
            row2.Cells.AddRange(new XRTableCell[] { cellDate2, cellVenousCatheter, cellAutologousFistula, cellTempVenousCatheter, cellArtificialVessel, cellDoubleVein, cellHighAvf, cellJugularVenousCatheter, cellSubclavianVenousCatheter, cellFemoralVenousCatheter });
            row2.Cells[0].WidthF = 101F;
            row2.Cells[1].WidthF = 125F;
            row2.Cells[2].WidthF = 95F;
            row2.Cells[3].WidthF = 135F;
            row2.Cells[4].WidthF = 95F;
            row2.Cells[5].WidthF = 85F;
            row2.Cells[6].WidthF = 140F;
            row2.Cells[7].WidthF = 125F;
            row2.Cells[8].WidthF = 140F;
            row2.Cells[9].WidthF = 114F;

            XRTable table3 = this.xrTable3;
            table3.Borders = (DevExpress.XtraPrinting.BorderSide)DevExpress.XtraPrinting.BorderSide.All;
            table3.BorderWidth = 1;
            table3.LocationFloat = new DevExpress.Utils.PointFloat(0F, 0F);
            table3.Name = "xrTable3";
            table3.SizeF = new SizeF(1060F, 25F);
            table3.Font = new System.Drawing.Font("Times New Roman", 9.75F, System.Drawing.FontStyle.Regular);
            table3.StylePriority.UseBorders = false;
            table3.StylePriority.UseTextAlignment = false;
            table3.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;

            table3.Rows.Clear();

            XRTableRow row3 = new XRTableRow();
            row3.Name = "xrTableRow3";
            row3.Weight = 1D;

            table3.Rows.AddRange(new XRTableRow[] { row3 });

            XRTableCell cellDate3 = new XRTableCell();
            cellDate3.Borders = (DevExpress.XtraPrinting.BorderSide)(DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Bottom | DevExpress.XtraPrinting.BorderSide.Right);
            cellDate3.Name = "xrTableCell16";
            cellDate3.Weight = 0.75D;
            cellDate3.StylePriority.UseBorders = false;
            cellDate3.DataBindings.AddRange(new XRBinding[] { new XRBinding("Text", null, "DATE_MONTH") });
            ...
            cellTimeLess8.Name = "xrTableCell17";
            ...
            cellTime8_9.Name = "xrTableCell18";
            ...
            cellTime9_10.Name = "xrTableCell19";
            ...
            cellTime10_11.Name = "xrTableCell20";
            ...
            cellTime11_12.Name = "xrTableCell21";
            ...
            cellTimeMore12.Name = "xrTableCell22";
            ...
            row3.Cells.AddRange(new XRTableCell[] { cellDate3, cellTimeLess8, cellTime8_9, cellTime9_10, cellTime10_11, cellTime11_12, cellTimeMore12 });

            row3.Cells[0].WidthF = 101F;
            row3.Cells[1].WidthF = 150F;
            row3.Cells[2].WidthF = 155F;
            row3.Cells[3].WidthF = 160F;
            row3.Cells[4].WidthF = 170F;
            row3.Cells[5].WidthF = 170F;
            row3.Cells[6].WidthF = 154F;

            XRTable table4 = this.xrTable4;
            table4.Borders = (DevExpress.XtraPrinting.BorderSide)DevExpress.XtraPrinting.BorderSide.All;
            table4.BorderWidth = 1;
            table4.LocationFloat = new DevExpress.Utils.PointFloat(0F, 0F);
            table4.Name = "xrTable4";
            table4.SizeF = new SizeF(695F, 25F);
            table4.Font = new System.Drawing.Font("Times New Roman", 9.75F, System.Drawing.FontStyle.Regular);
            table4.StylePriority.UseBorders = false;
            table4.StylePriority.UseTextAlignment = false;
            table4.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;

            table4.Rows.Clear();

            XRTableRow row4 = new XRTableRow();
            row4.Name = "xrTableRow4";
            row4.Weight = 1D;

            table4.Rows.AddRange(new XRTableRow[] { row4 });

            XRTableCell cellDate4 = new XRTableCell();
            cellDate4.Borders = (DevExpress.XtraPrinting.BorderSide)(DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Bottom | DevExpress.XtraPrinting.BorderSide.Right);
            cellDate4.Name = "xrTableCell23";
            cellDate4.Weight = 0.75D;
            cellDate4.StylePriority.UseBorders = false;
            cellDate4.DataBindings.AddRange(new XRBinding[] { new XRBinding("Text", null, "DATE_MONTH") });
            ...
            cellComfort.Name = "xrTableCell24";
            ...
            cellMildDiscomfort.Name = "xrTableCell25";
            ...
            cellSevereDiscomfort.Name = "xrTableCell26";
            ...
            cellPeritonealDialysis.Name = "xrTableCell27";
            ...
            row4.Cells.AddRange(new XRTableCell[] { cellDate4, cellComfort, cellMildDiscomfort, cellSevereDiscomfort, cellPeritonealDialysis });

            row4.Cells[0].WidthF = 101F;
            row4.Cells[1].WidthF = 145F;
            row4.Cells[2].WidthF = 175F;
            row4.Cells[3].WidthF = 175F;
            row4.Cells[4].WidthF = 99F;
        }
