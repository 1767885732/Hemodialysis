...
{
    public partial class EstimateVenousCatheterReport : DevExpress.XtraReports.UI.XtraReport
    {
        #region 成员变量
        ...
        public EstimateVenousCatheterReport(string hemoId, string patientNo, DateTime createDate)
        {
            this.hemoId = hemoId;
        ...
        {
            this.DataSource = hemodialysisService.GetEstimateVenousCatheterByHemoIdAndSingleDate(hemoId, createDate);
        }
