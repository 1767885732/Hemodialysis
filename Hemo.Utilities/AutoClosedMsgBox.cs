 ...
 */
    public class AutoClosedMsgBox
    {
        ...
        public static DialogResult ShowForm(string text, string caption, int milliseconds,MessageBoxIcon MsgIcon)
        {
            ...
            timer.Start();
            XtraMessageBox.Show(text, caption,MessageBoxButtons.OK,MsgIcon);
